...
suggestionB.addEventListener("click", function(e) {
  if (e.target && e.target.innerText !== "Fetching suggestions..." && e.target.innerText !== "Error fetching suggestion.") {
...
portfolioB.addEventListener("click", function(e) {
  if (e.target && e.target.innerText !== "Fetching data..." && e.target.innerText !== "Error fetching suggestion.") {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    input.addEventListener('input', function () {
        ...
        if (inputlength > 10) {
            ...
            suggestionBox.innerText = "Fetching suggestions...";
    ...
    portfolio.addEventListener('input', function () {
        ...
        if (inputlength  > 2 ) {
            suggestionBox.style.display = 'block';
            suggestionBox.innerText = "Fetching data...";
    ...
    experience.addEventListener('input', function () {
        const inputlength = parseInt(experience.value);
